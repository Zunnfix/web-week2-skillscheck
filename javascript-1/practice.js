...
// Create a function called 'lovesCodeChecker' that takes in a single parameter called x. Check to see if x 
// is equal to true. If it is, return true as a boolean. If x does not equal true, return false as a boolean
...
// Create a function called 'iLove' that takes in two parameters, name which will be a string  and love which will be a 
// string of something you love. Have the function take the two parameters and retrun a string that says "NAMEPARAM 
// loves LOVEPARAM" with the appropriate parameters in the string. e.g. "Bryan loves skateboarding"
...
let doubled = myNumbers.map(function(val,i,ar) {
...
let forTheLoveOfGeorge = notGeorge.map(function(i){
	notGeorge[i] = 'George'
})
...
let totallyAwesome = people.reduce((total, person) => {
...
let me = {
	...
	cohort: 'wdl24',
	phrase: 'If you judge a fish by its ability to climb a tree, it will live its whole life believing it is an idiot',
}